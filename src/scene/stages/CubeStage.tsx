 ...
 * positioned via `SHAPE_POSITION.cube` so the cube (geometry itself unchanged, still
 * centered on its own local origin) sits with one corner at the world origin — the same
 * corner `Grid.tsx`'s three positive-octant grid planes meet at, "like standing in the
 * corner of a room" per PLAN.md.
 */
export function CubeStage() {
  ...
  return (
    <group position={SHAPE_POSITION.cube}>
